...
import type { ConfigManager, RoutingRule, RouterConfig } from "../../src/config/index.js";
...
describe("Router", () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    router = new Router(mockConfigManager as unknown as ConfigManager, mockAnalytics as any);
  });
